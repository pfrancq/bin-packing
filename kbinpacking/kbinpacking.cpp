...
KBinPackingApp::KBinPackingApp():KMainWindow(0,"KBinPacking")
{
  config=kapp->config();
...
KBinPackingApp::~KBinPackingApp()
{
  delete printer;
}

void KBinPackingApp::initActions()
{
...
void KBinPackingApp::initStatusBar()
{
  ///////////////////////////////////////////////////////////////////
  // STATUSBAR
...
void KBinPackingApp::saveOptions()
{	
...
void KBinPackingApp::readOptions()
{
...
bool KBinPackingApp::queryClose()
{
...
void KBinPackingApp::slotFileNew()
{
...
void KBinPackingApp::slotFileOpen()
{
  slotStatusMsg(i18n("Opening file..."));
...
void KBinPackingApp::slotFileSave()
{
...
void KBinPackingApp::slotFileSaveAs()
{
...
void KBinPackingApp::slotFileClose()
{
...
void KBinPackingApp::slotFilePrint()
{
...
void KBinPackingApp::slotFileQuit()
{
...
void KBinPackingApp::slotEditUndo()
{
...
void KBinPackingApp::slotEditCut()
{
...
void KBinPackingApp::slotEditCopy()
{
...
void KBinPackingApp::slotEditPaste()
{
...
void KBinPackingApp::slotViewToolBar()
{
...
void KBinPackingApp::slotViewStatusBar()
{
...
void KBinPackingApp::slotWindowNewWindow()
{
...
void KBinPackingApp::slotWindowTile(){
  pWorkspace->tile();
}

void KBinPackingApp::slotWindowCascade(){
  pWorkspace->cascade();
}
...
void KBinPackingApp::windowMenuAboutToShow()
{
