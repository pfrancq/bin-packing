...
/**
  * The base class for KBinPacking application windows. It sets up the main
  ...
  * display whereby one document can have several views.The MDI child is an instance of KBinPackingView,
  * the document an instance of KBinPackingDoc.
  * KBinPackingApp reimplements the methods that KTMainWindow provides for main window handling and supports
...
class KBinPackingApp : public KMainWindow
{
  ...
  public:
    /** construtor of KBinPackingApp, calls all init functions to create the application.
