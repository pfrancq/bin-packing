...
void KBinPackingDoc::changedViewList(){	
...
bool KBinPackingDoc::isLastView() {
...
const KURL& KBinPackingDoc::URL() const
{
  return doc_url;
}

void KBinPackingDoc::closeDocument()
{
  KBinPackingView *w;
  if(!isLastView())
  {
...
bool KBinPackingDoc::newDocument()
{
  /////////////////////////////////////////////////
...
bool KBinPackingDoc::openDocument(const KURL &url, const char *format /*=0*/)
{
...
bool KBinPackingDoc::saveDocument(const KURL &url, const char *format /*=0*/)
{
//	QFile f( filename );
...
void KBinPackingDoc::deleteContents()
{
  /////////////////////////////////////////////////
